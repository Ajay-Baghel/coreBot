...
/* Excluded from this release type: DedicatedGatewayRequestOptions */
 ...
 */
export declare interface FeedOptions extends SharedOptions, DedicatedGatewayRequestOptions {
 ...
 */
export declare interface RequestOptions extends SharedOptions, DedicatedGatewayRequestOptions {
    /** Conditions Associated with the request. */
    accessCondition?: {
        /** Conditional HTTP method header type (IfMatch or IfNoneMatch). */
        type: string;
